...
public class ClientGameView {
	...
	public void initialize(){
        ...
        clientRacket.setHeight(100);
        clientRacket.setWidth(22);
        clientRacket.setPosition(100, boardHeight/2 - 50);
        
        serverRacket = new PongRacket();
        serverRacket.setRacketFill(Color.LIGHTCORAL);
        serverRacket.setHeight(100);
        serverRacket.setWidth(22);
        serverRacket.setPosition(boardWidth - 100, boardHeight/2 - 50);
        
        lowerBound = new PongRacket();
        lowerBound.setRacketFill(Color.LAWNGREEN);
        lowerBound.setHeight(5);
        lowerBound.setWidth(boardWidth);
        lowerBound.setPosition(0, boardHeight - 15);
        lowerBound.setHorizontalBoundary(true);
        
        upperBound = new PongRacket();
        upperBound.setRacketFill(Color.LAWNGREEN);
        upperBound.setHeight(5);
		...
		ball.setRadius(10);
		ball.setPosition(boardWidth/2 + 5, boardHeight/2 + 5);
