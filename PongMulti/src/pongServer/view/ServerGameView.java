...
/**
 * Klasa widoku gry aplikacji serwera.
 * 
...
public class ServerGameView {
	...
	/**
	 * Metoda zwracajaca losowy kat wyznaczajacy kierunek w ktorym porusza sie
	 * pileczka po inicjalizacji widoku, np. zdobyciu punktu.
	 * 
	 * @author mdziendzikowski
	 * @return kat opisujacy kierunek poruszania sie pileczki. Kat jest
	 *         ograniczony do 60 stopni wzgledem osi horyzontalnej ekranu.
	 */
